...
class UserCreationForm(ModelForm):
    username = forms.RegexField(label="", widget=forms.TextInput(attrs={'placeholder': 'Username'}), max_length=30, regex=r'^[\w.@+-]+$',
    ...
    email1 = forms.EmailField(label="", widget=forms.TextInput(attrs={'placeholder': 'Email'}), max_length=75)
    email2 = forms.EmailField(label="", widget=forms.TextInput(attrs={'placeholder': 'Email confirmation'}), max_length=75,
    ...
    def save(self, commit=True, domain_override=None,
        ...
        send_mail("Confirmation link sent on %s" % site_name,
                  t.render(Context(c)), 'narobert1370@gmail.com', [user.email])
        return user
